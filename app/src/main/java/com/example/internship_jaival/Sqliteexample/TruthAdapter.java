...
import static com.example.internship_jaival.Sqliteexample.Sqlite_Activity.nodatafound;
...
import com.example.internship_jaival.oneto20game.GameAdapter;

import java.util.ArrayList;

public class TruthAdapter extends RecyclerView.Adapter<TruthAdapter.ViewHolder> {

    Context context;
    ArrayList<StudentDataModel> arrayList;

    public TruthAdapter(Context context, ArrayList<StudentDataModel> arrayList) {
    ...
    @NonNull
    @Override
    public TruthAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull TruthAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
